...
:checkDLL
	...
	reg query "HKLM\SOFTWARE\Classes\CLSID\{BC5C71ED-2E00-40A4-8A9E-1B9CE71384CB}" >nul 2>&1 /reg:32
	if %errorLevel% == 0 (
...
:CheckDLLContinue
	...
	reg query "HKLM\SOFTWARE\Classes\CLSID\{BC5C71ED-2E00-40A4-8A9E-1B9CE71384CB}" >nul 2>&1 /reg:64
	if %errorLevel% == 0 (
